...
| **Lean baseline-sketch fallback** | Hermes-refined Lean fails to compile under `lake env lean` | n/a — happens *after* the LLM stage | `fallback_count` (refined Lean failed → catalogue baseline used) |
