...
6. manifested composition leaves with **{{formalism.metrics.theorem_witnessed_relations}}** declaration-witnessed cross-topic relations, typed as derivational edges or non-implicational formal pairings, and an import-only aggregate;
