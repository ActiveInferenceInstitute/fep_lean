...
- **fep-002** directly formalizes a narrow KL-remainder variational bound in `ℝ≥0∞`, including exactness when the approximation equals the posterior. The finite active-inference foundation separately constructs evidence and posterior from one normalized joint and proves posterior VFE attainment; a finite-to-measure bridge remains open.
