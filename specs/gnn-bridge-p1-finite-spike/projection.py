...
repository state: the explicit inputs include the pinned commit references and owner digests,
...
Modes:
  ...
  --check    freshness gate (style of `fep-lean atlas --check`): exit 0
             ...
             and its recorded owner digests equal the source pin;
...
def write_document() -> int:
    ...
    emit(FEP_LEAN_ROOT, GNN_ROOT, "finite")
    return 0
...
def check_document() -> int:
    ...
    return 0 if emit(FEP_LEAN_ROOT, GNN_ROOT, "finite", check=True) else 1
