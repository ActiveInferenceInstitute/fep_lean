...
DTos:prior_initialization :: D -> s:prior_initialization
DTos:prior_initialization x = undefined
sToB:transition :: s -> B:transition
sToB:transition x = undefined
BTos_prime:state_prediction :: B -> s_prime:state_prediction
BTos_prime:state_prediction x = undefined
s_primeToA:likelihood :: s_prime -> A:likelihood
s_primeToA:likelihood x = undefined
AToo:observation_mapping :: A -> o:observation_mapping
AToo:observation_mapping x = undefined
EToπ:prior_policy :: E -> π:prior_policy
EToπ:prior_policy x = undefined
πToB:policy_conditioned_transition :: π -> B:policy_conditioned_transition
πToB:policy_conditioned_transition x = undefined
CToG:pragmatic_cost :: C -> G:pragmatic_cost
CToG:pragmatic_cost x = undefined
GToπ:policy_selection :: G -> π:policy_selection
GToπ:policy_selection x = undefined
