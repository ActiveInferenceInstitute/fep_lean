...
def main() -> int:
    ...
    "connections": [
        ...
        },
        {
            "source": "B",
            "relation": ">",
            "target": "s_prime:state_prediction"
        },
        {
            "source": "s_prime",
            "relation": "-",
        ...
        },
        {
            "source": "A",
            "relation": "-",
            "target": "o:observation_mapping"
        },
        {
            "source": "E",
            "relation": ">",
            "target": "\u03c0:prior_policy"
        },
        {
            "source": "\u03c0",
            "relation": "-",
            "target": "B:policy_conditioned_transition"
        },
        {
            "source": "C",
            "relation": ">",
            "target": "G:pragmatic_cost"
        },
        {
            "source": "G",
            "relation": ">",
            "target": "\u03c0:policy_selection"
        }
    ],
    "ontology_mapping": {
        "A": "LikelihoodMatrix",
