theory FepLeanSymmetricBooleanGenerativeModel
imports Main
begin

text \<open>FepLean Symmetric Boolean Generative Model\<close>
text \<open>Bridge P1 spike: the fep_lean active_inference.lean
...
- The Lean GenerativeModel carries no Action type, so no `u`
  variable or action edges are emitted.\<close>
