...
def artifactF : ℝ := (828390857088487 / 2251799813685248 : ℝ)
def artifactQ : ℝ := (7788207392432013 / 9007199254740992 : ℝ)
def artifactH : ℝ := (1 / 1 : ℝ)
def artifactR : ℝ := (1 / 1 : ℝ)
def artifactPriorMean : ℝ := (0 / 1 : ℝ)
def artifactPriorCov : ℝ := (1 / 1 : ℝ)
