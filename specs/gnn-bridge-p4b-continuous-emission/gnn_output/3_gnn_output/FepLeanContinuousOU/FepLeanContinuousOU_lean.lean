-- GNN Model in Lean 4
-- Model: FepLean Continuous OU Linear-Gaussian Model
...
namespace FepLeanContinuousOULinearGaussianModel
...
variable (Q : ℝ)
variable (R : ℝ)
variable (prior_cov : ℝ)
variable (prior_mean : ℝ)
variable (t : ℤ)
variable (u : ℝ)
variable (x : ℝ)
variable (y : ℝ)

structure FepLeanContinuousOULinearGaussianModelModel where
  F : ℝ
  H : ℝ
  Q : ℝ
  R : ℝ
