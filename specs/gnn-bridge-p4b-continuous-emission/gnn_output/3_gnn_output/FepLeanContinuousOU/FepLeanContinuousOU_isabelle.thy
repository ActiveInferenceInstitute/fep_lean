theory FepLeanContinuousOULinearGaussianModel
imports Main
begin

text \<open>FepLean Continuous OU Linear-Gaussian Model\<close>
text \<open>Bridge P4b slice: the fep_lean scalar OU filter instance
...
- prior_mean = 0, prior_cov = stationary variance = 1 (proved)
  [smooth_reference_kernel.lean:66-68, 96-101]\<close>
