...
Positive accepted H2.7 evidence authorizes the primary continuous carrier for
H3.1--H3.5 formal work and H3.6S synthetic work. Governed interface,
...
H3.G0 has no manifest tuple: it is an append-only candidate, review-history,
capability-snapshot, and final-receipt lifecycle over immutable H1/H2 evidence.
H3.0 remains a hard scheduling dependency of H3.1 even though a preregistration
artifact is not a Lean import. Neither
...
**Single owners:** prospective `specs/h3-reference-study/preregistration.yaml`
...
- final H3.G0 acceptance-receipt hash and the exactly-one continuous/finite
  branch;
...
synthetic case study as such, and record the missing data capability.
Do not change the research question after inspecting outcomes.
