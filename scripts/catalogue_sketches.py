...
``abbrev Policy`` / ``abbrev Sensory`` give finite discrete semantics; measure statements use
``MeasureTheory`` primitives that hold for arbitrary measurable spaces.
"""
...
from theorem_latex_signatures import build_theorem_latex_from_sketches

# id -> lean body (must compile with import Mathlib + opens from lean_verifier._wrap_lean_code)
SKETCHES: dict[str, str] = {
    "fep-001": """import Mathlib.MeasureTheory.Measure.MeasureSpace
...
""",
    "fep-002": """import Mathlib.MeasureTheory.Measure.MeasureSpace
...
""",
    "fep-003": """import Mathlib.Algebra.BigOperators.Group.Finset.Basic
...
""",
    "fep-004": """import Mathlib.Analysis.InnerProductSpace.Basic
...
""",
    "fep-006": """import Mathlib.MeasureTheory.Measure.MeasureSpace
...
""",
    "fep-009": """import Mathlib.MeasureTheory.Measure.MeasureSpace
...
""",
    "fep-010": """import Mathlib.Analysis.SpecialFunctions.Exp
...
""",
    "fep-013": """import Mathlib.Analysis.SpecialFunctions.Log.Basic
...
""",
    "fep-014": """import Mathlib.MeasureTheory.Measure.MeasureSpace
...
""",
    "fep-015": """import Mathlib.MeasureTheory.MeasurableSpace.Basic
...
""",
    "fep-016": """import Mathlib.Analysis.SpecialFunctions.Pow.Real
...
""",
    "fep-017": """import Mathlib.Algebra.BigOperators.Group.Finset.Basic
import Mathlib.Algebra.Order.BigOperators.Group.Finset
import Mathlib.Data.Real.Basic
...
""",
    "fep-018": """import Mathlib.Analysis.InnerProductSpace.PiL2
...
""",
    "fep-019": """import Mathlib.Algebra.BigOperators.Group.Finset.Basic
import Mathlib.Algebra.Order.BigOperators.Group.Finset
import Mathlib.Data.Real.Basic
...
""",
    "fep-020": """import Mathlib.Analysis.SpecialFunctions.Pow.Real
...
""",
    "fep-021": """import Mathlib.Order.Basic
...
""",
    "fep-022": """import Mathlib.MeasureTheory.Measure.MeasureSpace
...
""",
    "fep-023": """import Mathlib.Data.Finset.Basic
...
""",
    "fep-024": """import Mathlib.Analysis.SpecialFunctions.Log.Basic
...
""",
    "fep-025": """import Mathlib.LinearAlgebra.Matrix.Defs
...
""",
    "fep-027": """import Mathlib.MeasureTheory.Measure.Prod
...
""",
    "fep-030": """import Mathlib.Analysis.SpecialFunctions.Log.Basic
...
""",
    "fep-032": """import Mathlib.Analysis.SpecialFunctions.Pow.Real
...
""",
    "fep-033": """import Mathlib.Algebra.BigOperators.Group.Finset.Basic
import Mathlib.Algebra.Order.BigOperators.Group.Finset
import Mathlib.Data.Real.Basic
...
""",
    "fep-034": """import Mathlib.Algebra.BigOperators.Group.Finset.Basic
import Mathlib.Algebra.Order.BigOperators.Group.Finset
import Mathlib.Data.Real.Basic
...
""",
    "fep-035": """import Mathlib.Analysis.SpecialFunctions.Log.Basic
...
""",
    "fep-036": """import Mathlib.MeasureTheory.Measure.MeasureSpace
...
""",
    "fep-037": """import Mathlib.Analysis.SpecialFunctions.Exp
...
""",
    "fep-038": """import Mathlib.Analysis.InnerProductSpace.Basic
import Mathlib.Analysis.SpecialFunctions.Pow.Real
...
""",
    "fep-040": """import Mathlib.Analysis.SpecialFunctions.Log.Basic
...
""",
    "fep-041": """import Mathlib.Algebra.BigOperators.Group.Finset.Basic
import Mathlib.Algebra.Order.BigOperators.Group.Finset
import Mathlib.Data.Real.Basic
...
""",
    "fep-042": """import Mathlib.MeasureTheory.MeasurableSpace.Basic
...
""",
    "fep-043": """import Mathlib.Analysis.Calculus.Deriv.Basic
...
""",
    "fep-044": """import Mathlib.Analysis.SpecialFunctions.Pow.Real
...
""",
    "fep-045": """import Mathlib.Data.List.Basic
...
""",
    "fep-046": """import Mathlib.Algebra.Order.Field.Basic
import Mathlib.Data.Real.Basic
import Mathlib.Tactic
...
""",
    "fep-047": """import Mathlib.Algebra.BigOperators.Group.Finset.Basic
import Mathlib.Algebra.Order.BigOperators.Group.Finset
import Mathlib.Data.Real.Basic
...
""",
    "fep-049": """import Mathlib.Algebra.Order.Ring.Basic
import Mathlib.Tactic
...
""",
    "fep-050": """import Mathlib.Analysis.SpecialFunctions.Log.Basic
...
# One LaTeX display string per ``theorem`` name; derived from ``SKETCHES`` (full-signature form).
THEOREM_LATEX: dict[str, str] = build_theorem_latex_from_sketches(SKETCHES)
...
def _build_latex_equations() -> dict[str, list[str]]:
    out: dict[str, list[str]] = {}
    for tid, body in SKETCHES.items():
        names = _theorem_names_in_order(body)
        out[tid] = [THEOREM_LATEX[n] for n in names]
    return out


# One display-math string per ``theorem`` in ``SKETCHES`` (same order as source).
LATEX_EQUATIONS: dict[str, list[str]] = _build_latex_equations()


def assert_latex_complete() -> None:
    """Every topic has one LaTeX string per theorem; ``THEOREM_LATEX`` covers all names."""
    for tid, body in SKETCHES.items():
        n_th = len(re.findall(r"^\s*theorem\s+", body, re.MULTILINE))
        rows = LATEX_EQUATIONS.get(tid, [])
        if n_th != len(rows):
            raise ValueError(
                f"{tid}: theorem count {n_th} != latex_equations count {len(rows)}"
            )
        for n in _theorem_names_in_order(body):
            if n not in THEOREM_LATEX:
                raise KeyError(f"Missing THEOREM_LATEX entry for theorem {n!r}")


def assert_complete() -> None:
    expected = [f"fep-{i:03d}" for i in range(1, 51)]
    missing = [k for k in expected if k not in SKETCHES]
    extra = [k for k in SKETCHES if k not in expected]
    if missing or extra:
        raise ValueError(f"SKETCHES keys mismatch: missing={missing!r} extra={extra!r}")
    assert_latex_complete()
