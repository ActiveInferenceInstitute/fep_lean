...
METADATA: list[tuple[str, str, str, str, str]] = [
    ...
    (
        "fep-002",
        "Gibbs Free Energy as Marginal Likelihood",
        "FEP",
        "MeasureTheory.Measure.MeasureSpace",
        "real",
    ),
    ...
    (
        "fep-008",
        "Active Inference Optimal Policy",
        "ActiveInference",
        "Data.Finset.Basic, Order.Bounds.Basic",
        "real",
    ),
    (
        "fep-009",
    ...
    (
        "fep-014",
        "KL Divergence: Non-Negativity, Chain Rule, Data Processing",
        "InfoGeometry",
        "MeasureTheory.Measure.MeasureSpace",
        "real",
    ),
    (
        "fep-015",
        "Measurability of Variational Objectives",
        "FEP",
    ...
    (
        "fep-017",
        "Conditional Expectation in Bayesian Updates",
        "InfoGeometry",
        "Algebra.BigOperators.Group.Finset",
        "real",
    ),
    ...
    (
        "fep-023",
        "Affordance: Reachable Distributions",
        "ActiveInference",
        "Data.Finset.Basic, Data.Set.Basic",
        "real",
    ),
    (
        "fep-024",
        "KL Regularization in Objectives",
        "InfoGeometry",
        "Analysis.SpecialFunctions.Log.Basic",
        "real",
    ),
    ...
    (
        ...
        "ActiveInference",
        "Data.Finset.Basic, Analysis.SpecialFunctions.Exp",
        "real",
    ),
    ...
    (
        "fep-033",
        "Planning Horizon in Active Inference",
        "ActiveInference",
        "Algebra.BigOperators.Group.Finset",
        "real",
    ),
    (
        "fep-034",
        "Discrete Belief Update (Categorical)",
        "ActiveInference",
        "Algebra.BigOperators.Group.Finset",
        "real",
    ),
    ...
    (
        "fep-040",
        "Gaussian Entropy and Heat Capacity",
        "BayesianMechanics",
        "Analysis.SpecialFunctions.Log.Basic",
        "real",
    ),
    (
        "fep-041",
        "Exploration Bonus from Information Gain",
        "ActiveInference",
        "Algebra.BigOperators.Group.Finset",
        "real",
    ),
    ...
    (
        "fep-043",
        "Critical Points of Free Energy",
        "FEP",
    ...
    (
        "fep-047",
        "Active Inference Message Passing",
        "ActiveInference",
        "Algebra.BigOperators.Group.Finset",
        "real",
    ),
    ...
    (
        "fep-050",
        "Landauer Bound and Information Thermodynamics",
        "Thermodynamics",
        "Analysis.SpecialFunctions.Log.Basic",
        "real",
    ),
...
def main() -> None:
    ...
    out.write_text(
        header + yaml.dump(data, sort_keys=False, allow_unicode=True, width=120),
        encoding="utf-8",
    )
